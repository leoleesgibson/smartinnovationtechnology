  ...
  const contactMethods = [
    {
      ...
      title: "Email Us",
      value: "contact@sitechnologies.com",
      link: "mailto:contact@sitechnologies.com"
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400"> Smarter</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            {contactMethods.map((method, index) => (
              <motion.a
                ...
                className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 flex flex-col items-center text-center group"
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="security" className="bg-gray-900">Smart Security</option>
                      <option value="automation" className="bg-gray-900">Home Automation</option>
                      <option value="energy" className="bg-gray-900">Energy Management</option>
                      <option value="entertainment" className="bg-gray-900">Entertainment Systems</option>
                    </select>
                  </div>
                </div>
